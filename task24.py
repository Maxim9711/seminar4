...
numBushes = int(input('Количество кустов: '))
arrBerry = list()
for i in range(numBushes):
    numBerry = int(input('Количество ягод: '))
    arrBerry.append(numBerry)

maxBerry = list()
for i in range(len(arrBerry)):
       maxBerry.append(arrBerry[i] + arrBerry[i-2] + arrBerry[i-1])
print(max(maxBerry))